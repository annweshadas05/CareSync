...
<body class="admin-bg">
    ...
    <div class="sidebar shadow">
        ...
        <nav class="nav flex-column">
            <a class="nav-link" href="doctor_dashboard.php"><i data-lucide="layout-grid"></i> <span>Dashboard</span></a>
            <a class="nav-link active" href="#"><i data-lucide="users"></i> <span>Patients</span></a>
            <a href="../logout.php" class="nav-link logout-link text-danger fw-bold">
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                <h2 class="fw-bold mb-0">Check Registerd Patient</h2>
            </div>
        </div>
