...
<body class="admin-bg">
    ...
    <div class="sidebar shadow">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link" href="manage_schedule.php"><i data-lucide="user-cog"></i> <span>Manage Schedule</span></a>
            <a class="nav-link" href="look_patient.php"><i data-lucide="users"></i> <span>Patients</span></a>
